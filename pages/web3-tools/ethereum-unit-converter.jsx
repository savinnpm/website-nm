...
import { EthereumUnitConverter } from '../../src/views/EthereumUnitConverter/index.jsx'

export async function getStaticProps ({ locale }) {
  const s = await serverSideTranslations(locale, ['common', 'ethereum-unit-converter'])
  return {
    props: {
      ...(s),
...
export default function EthereumUnitConverterPage () {
