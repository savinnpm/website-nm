...
const SvgJbDatagrip = (props) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#clip0_1334_1472)">
      <path
      ...
      />
      <path
        d="M8.1377 8.68567H11.3377C13.8977 8.68567 15.6806 10.4685 15.6806 12.7542V12.8C15.6806 15.0857 13.8977 16.8685 11.3377 16.8685H8.1377V8.68567ZM9.92055 10.3314V15.2685H11.292C12.7548 15.2685 13.7606 14.2628 13.7606 12.8457V12.8C13.7606 11.3371 12.7548 10.3314 11.292 10.3314H9.92055Z"
        fill="white"
      />
      <path
    ...
    <defs>
      ...
      <clipPath id="clip0_1334_1472">
        <rect width={32} height={32} fill="white" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgJbDatagrip;
