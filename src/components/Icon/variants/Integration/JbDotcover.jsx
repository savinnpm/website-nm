...
const SvgJbDotcover = (props) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#clip0_1334_1536)">
      <path
        d="M19.5657 0L0 2.19429V12.2514L4.89143 28.6171L29.5314 22.3543L19.5657 0Z"
        fill="url(#paint0_linear_1334_1536)"
      />
      <path
        d="M31.9999 18.8801L30.1256 10.1486L25.9199 15.9543L22.9942 24.7772L22.0342 32.0001L29.257 27.4286L31.9999 18.8801Z"
        fill="url(#paint1_linear_1334_1536)"
      />
      <path
        d="M30.1252 10.1486L23.9995 7.22284L16.8224 7.86284L9.78238 12.7543L8.36523 21.5314L14.5367 29.9428L22.0338 32L30.1252 10.1486Z"
        fill="url(#paint2_linear_1334_1536)"
      />
      <path
      ...
      <path
        d="M16.1826 12.8457C16.1826 10.5142 17.9198 8.59424 20.434 8.59424C21.9883 8.59424 22.9026 9.0971 23.6798 9.87424L22.5369 11.2C21.8969 10.6057 21.2569 10.2857 20.434 10.2857C19.0626 10.2857 18.0569 11.4285 18.0569 12.8457V12.8914C18.0569 14.3085 19.0169 15.4514 20.434 15.4514C21.3483 15.4514 21.9426 15.0857 22.5826 14.4914L23.7255 15.6342C22.9026 16.5485 21.9426 17.0971 20.3883 17.0971C18.0112 17.0514 16.1826 15.2228 16.1826 12.8457Z"
        fill="white"
      />
    </g>
    <defs>
      <linearGradient
        id="paint0_linear_1334_1536"
        x1={16.9367}
        y1={25.4341}
        x2={10.7694}
        y2={2.47863}
      ...
      <clipPath id="clip0_1334_1536">
        <rect width={32} height={32} fill="white" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgJbDotcover;
