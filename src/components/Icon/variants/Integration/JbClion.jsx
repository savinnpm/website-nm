...
const SvgJbClion = (props) => (
  ...
  >
    ...
    <defs>
      ...
      <clipPath id="clip0_1334_1430">
        <rect width={32} height={32} fill="white" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgJbClion;
