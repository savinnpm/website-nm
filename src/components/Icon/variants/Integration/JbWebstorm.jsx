...
const SvgJbWebstorm = (props) => (
  ...
  >
    ...
    <defs>
      ...
      <clipPath id="clip0_1334_1527">
        <rect width={32} height={32} fill="white" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgJbWebstorm;
